		...
		<div className='relative bg-white overflow-hidden flex-grow'>
					...
					<div className='mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
						<div className='sm:text-center lg:text-left'>
							<h2 className='text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl'>
								...
								<span className='text-blue-600'> secure passwords</span>
							</h2>
							<p className='mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0'>
								Password Saver is a utility designed from the ground up for an
								intuitive user experience. Overflowing with simplicity, password
								saver emphasizes what really matters-- efficient access to your
								favorite sites without compromising security. You can generate
								secure passwords, store saved passwords and copy them to your
								clip board.
							</p>
			...
			<div className='lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2'>
				<img
					...
					src={require('../../images/adult-blur-boss-business-288477.jpg')}
					alt='Adult Boss Businessman'
				/>
			</div>
		</div>
	);
...
export default SecurePasswords;
